...
import 'package:jramogh/providers/api_provider.dart';
import 'package:jramogh/widgets/blog_widget.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              elevation: 0.0,
              onPressed: () =>
                  html.window.open(Constants.PROFILE_GITHUB, 'amogh-jrules'),
            )
          ],
        ),
      ),
